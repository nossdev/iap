...
For per-code descriptions and remediation steps, see [Error handling guide](/v5/guide/error-handling).
...
- [Error handling guide](/v5/guide/error-handling) — full per-code reference + UI patterns
- [`BackendAdapter`](/v5/api/backend-adapter) — how custom adapters surface errors
