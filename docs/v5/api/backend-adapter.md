...
- [Backend contract](/v5/guide/backend-contract) — wire-format reference
- [Configuration](/v5/guide/configuration#custom-transport) — how to wire in your adapter
- [Errors](/v5/api/errors) — `IAPError` shape your adapter throws
