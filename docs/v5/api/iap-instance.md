...
The object returned by [`createIAP<TEntitlement>(config)`](/v5/api/create-iap).
...
See [Events guide](/v5/guide/events) and [`EventMap`](/v5/api/events-reference) for full payload definitions.

## See also

- [Events](/v5/guide/events) — full payload reference
- [Error handling](/v5/guide/error-handling) — every code each method can throw
- [Configuration](/v5/guide/configuration) — what gets passed to `createIAP`
