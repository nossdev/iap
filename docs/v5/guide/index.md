...
3. **`tx.finish()` only happens AFTER backend validation succeeds.** This is the core safety guarantee — see [Safety guarantees](/v5/guide/safety-guarantees).

## Next steps

- [Getting started](/v5/guide/getting-started) — install + first purchase in under 30 minutes
