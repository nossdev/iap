...
- [React recipe](/v5/recipes/react) — same patterns with hooks
- [Pinia store](/v5/recipes/pinia-store) — typed store with subscriber pattern (zoomed-in)
