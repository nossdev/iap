...
This recipe is the typed Pinia store from the [Vue + Quasar recipe](/v5/recipes/vue-quasar) with extra patterns: scoped subscriber, derived state, and a logout hook.
...
- [Vue + Quasar recipe](/v5/recipes/vue-quasar) — full recipe including paywall and components
- [Events](/v5/guide/events) — what each subscriber handler receives
- [Error handling](/v5/guide/error-handling) — `lastError` strategies
