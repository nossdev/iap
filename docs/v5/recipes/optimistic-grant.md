...
- [Safety guarantees](/v5/guide/safety-guarantees) — why the default flow is the way it is
- [Events](/v5/guide/events) — full event reference
- [Pinia store recipe](/v5/recipes/pinia-store) — base store this pattern extends
