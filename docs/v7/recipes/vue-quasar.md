...
- [React recipe](/v7/recipes/react) — same patterns with hooks
- [Pinia store](/v7/recipes/pinia-store) — typed store with subscriber pattern (zoomed-in)
