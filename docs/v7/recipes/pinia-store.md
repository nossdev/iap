...
This recipe is the typed Pinia store from the [Vue + Quasar recipe](/v7/recipes/vue-quasar) with extra patterns: scoped subscriber, derived state, and a logout hook.
...
- [Vue + Quasar recipe](/v7/recipes/vue-quasar) — full recipe including paywall and components
- [Events](/v7/guide/events) — what each subscriber handler receives
- [Error handling](/v7/guide/error-handling) — `lastError` strategies
