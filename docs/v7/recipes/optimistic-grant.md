...
- [Safety guarantees](/v7/guide/safety-guarantees) — why the default flow is the way it is
- [Events](/v7/guide/events) — full event reference
- [Pinia store recipe](/v7/recipes/pinia-store) — base store this pattern extends
