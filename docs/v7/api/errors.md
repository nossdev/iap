...
For per-code descriptions and remediation steps, see [Error handling guide](/v7/guide/error-handling).
...
- [Error handling guide](/v7/guide/error-handling) — full per-code reference + UI patterns
- [`BackendAdapter`](/v7/api/backend-adapter) — how custom adapters surface errors
