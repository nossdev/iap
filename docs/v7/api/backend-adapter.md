...
- [Backend contract](/v7/guide/backend-contract) — wire-format reference
- [Configuration](/v7/guide/configuration#custom-transport) — how to wire in your adapter
- [Errors](/v7/api/errors) — `IAPError` shape your adapter throws
