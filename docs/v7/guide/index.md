...
3. **`tx.finish()` only happens AFTER backend validation succeeds.** This is the core safety guarantee — see [Safety guarantees](/v7/guide/safety-guarantees).

## Next steps

- [Getting started](/v7/guide/getting-started) — install + first purchase in under 30 minutes
