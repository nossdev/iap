...
This is the event you wire to your Pinia / React / Svelte store. See [Vue + Quasar recipe](/v7/recipes/vue-quasar) and [React recipe](/v7/recipes/react) for full examples.
:::
...
See [`EventMap`](/v7/api/events-reference) for the full mapping.

## Next

- [Error handling](/v7/guide/error-handling) — every `IAPErrorCode` and how to recover
- [Vue + Quasar recipe](/v7/recipes/vue-quasar) — Pinia store wired to events
- [React recipe](/v7/recipes/react) — `useIAP()` hook pattern
